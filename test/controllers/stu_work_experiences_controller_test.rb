...
class StuWorkExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create stu_work_experience" do
    assert_difference('StuWorkExperience.count') do
      post :create, stu_work_experience: { description: @stu_work_experience.description, end_date: @stu_work_experience.end_date, position: @stu_work_experience.position, start_date: @stu_work_experience.start_date }
    end
  ...
  test "should update stu_work_experience" do
    patch :update, id: @stu_work_experience, stu_work_experience: { description: @stu_work_experience.description, end_date: @stu_work_experience.end_date, position: @stu_work_experience.position, start_date: @stu_work_experience.start_date }
    assert_redirected_to stu_work_experience_path(assigns(:stu_work_experience))
  end
