...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { description: @interaction.description, interaction_id: @interaction.interaction_id, interaction_type: @interaction.interaction_type }
    end
  ...
  test "should update interaction" do
    patch :update, id: @interaction, interaction: { description: @interaction.description, interaction_id: @interaction.interaction_id, interaction_type: @interaction.interaction_type }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
